...
public abstract class AutocompletarItem2 extends Autocompletar<Item> implements
		Serializable {
	...
	public List<Item> completarBusqueda(String query) {
		return getService().findByCriterio(query,TipoInventarioEnum.MATERIA_PRIMA.ordinal()+1);
	}
